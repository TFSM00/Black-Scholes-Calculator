...
r = st.sidebar.number_input("Risk-Free Rate", min_value=0.000, max_value=1.000, step=0.0001)
S = st.sidebar.number_input("Underlying Asset Price", min_value=1.00, step=0.01)
K = st.sidebar.number_input("Strike Price", min_value=1.00, step=0.01)
days_to_expiry = st.sidebar.number_input("Days left until Expiry Date", min_value=1, step=1)
sigma = st.sidebar.number_input("Volatility", min_value=0.000, max_value=1.000, step=0.0001)
